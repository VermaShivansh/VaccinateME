    ...
    <div className="midbody d-flex justify-content-center flex-column pt-4">
      ...
      <div className="container col-md-12 align-self-center mb-4" style={{ color: "white" }}>
        ...
        <li className="mt-2 mb-2">
          <strong>Please Note:-</strong> It is an app based upon the idea of how would vaccination process work if it was door-to-door. We are not connected to any official organization and no one will actually come to vaccinate you. The project is an open-source and can be accessed at{" "}
